...
|----------|-------|----------|
| **AR-SAT** | P2P | AR destekli ilan platformu — Letgo/Sahibinden benzeri ama ürünü AR'da gör |
| **PARS Rent** | P2P / B2C | Araç, ekipman, mülk kiralama |
| **FarmDirect** | B2C | Tarımdan halka doğrudan satış (CEO-AGRICULTURE entegrasyonu) |
| **PARS Auction** | P2P / B2B | Online müzayede: açık artırma + sabit fiyat + "Hemen Al" |
| **SharedOwn** | P2P | Ortak mülkiyet ve pay yönetimi (ev, arsa, araç) |
| **Digital Market** | B2C / P2P | Dijital ürünler, NFT, lisans satışı |
| **AR Showcase** | B2C | Ürünleri PARAVERSE AR'da görüntüle, salonuna koy |
